...
import { ArrowLeft, Save, Upload, UserCheck, Building, Plus, X, Camera } from 'lucide-react';

const EditSupervisorPage = ({ params }: { params: { id: string } }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push(`/dashboard/supervisors/${params.id}`);
  };
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Edit Supervisor</h1>
          <p className="text-sm text-muted-foreground">Update supervisor profile and settings</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update supervisor's profile image</CardDescription>
            </CardHeader>
          ...
          <Card className="lg:col-span-3">
            <CardHeader>
              ...
              <CardDescription>Update the supervisor's personal details</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Update certifications, skills, and languages</CardDescription>
          </CardHeader>
