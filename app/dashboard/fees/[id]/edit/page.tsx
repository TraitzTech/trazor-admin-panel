...
const EditFeePage = ({ params }: { params: { id: string } }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push(`/dashboard/fees/${params.id}`);
  };
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Edit Fee Record</h1>
          <p className="text-sm text-muted-foreground">Update fee record details</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-2">
            <CardHeader>
              ...
              <CardDescription>Update the fee details and payment information</CardDescription>
            </CardHeader>
